...
addCookie.onclick = () => {
    ...
    document.cookie = "jaloliddin=test; max-age="+60*60*24*30;
    if(document.cookie){//agarda cookie saqlansa
        cookieCard.classList.add('hide');//cardimizni yashirib qo'yadi
    }else{//aks holda alertda xabar chiqaradi xatolik haqida
        alert("Cookie saqlanmadi!")
    }
}

const checking = document.cookie.indexOf("jaloliddin=test");
